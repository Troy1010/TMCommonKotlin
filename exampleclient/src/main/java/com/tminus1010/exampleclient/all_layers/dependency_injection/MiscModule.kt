...
object MiscModule {
    ...
    @Provides
    fun provideSpeechToText(application: Application): com.tminus1010.tmcommonkotlin.speechtotext.SpeechToText = com.tminus1010.tmcommonkotlin.speechtotext.SpeechToText(application)
    ...
    @Provides
    fun provideOpenMicForSpeechToText(application: Application): com.tminus1010.tmcommonkotlin.speechtotext.OpenMicForSpeechToText = com.tminus1010.tmcommonkotlin.speechtotext.OpenMicForSpeechToText(application)
}